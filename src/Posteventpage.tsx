    ...
    <div style={{ minHeight:"100vh", background:C.white, fontFamily:"'Nunito',sans-serif" }}>
      ...
      <div style={{ maxWidth:660, margin:"0 auto", padding:"48px 24px 80px" }}>
        ...
        <Block title="Team & Media" icon="fa-solid fa-users">
          <Field label="Required Roles" name="roles" form={form} errors={errors} set={set} inputStyle={inputStyle} ph="Frontend Dev, Designer, ML Engineer (comma separated)"/>
          <Field label="Poster Image URL" name="poster" form={form} errors={errors} set={set} inputStyle={inputStyle} ph="https://your-image.com/poster.jpg"/>
        </Block>
